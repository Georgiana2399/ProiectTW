module.exports = (req, res) => {
  ...
  //params.judet = params.judet.toUpperCase();
  console.log(params.judet + "" + judeteAll[parseInt(params.judet)]);
  //var sqlCommand = `SELECT * FROM medii_aprilie WHERE judet = ' ${params.judet}'`;
  var sqlCommand = `SELECT * FROM medii_aprilie WHERE judet = ' ${
